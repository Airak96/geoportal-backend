        ...
        >
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              ...
              <div v-show="message !== ''" class="flex gap-x-1 items-center mt-2 bg-indigo-700 text-white py-2 px-3 rounded">
          ...
          <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            ...
            <button @click="closeModal(handleReset)" type="button" :disabled="executed" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Cancelar</button>
          </div>
        </div>
      </div>
    </div>
