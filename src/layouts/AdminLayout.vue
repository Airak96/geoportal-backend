        ...
        <div class="flex h-16 justify-between">
          <div class="flex">
            ...
            <div class="hidden md:ml-6 md:flex md:space-x-8">
              ...
              <RouterLink v-if="user?.data?.role === 'admin'" to="/admin/users" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Usuarios</RouterLink>
              <RouterLink v-if="user?.data?.role === 'admin'" to="/admin/visitors" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Visitantes</RouterLink>
            </div>
          </div>
